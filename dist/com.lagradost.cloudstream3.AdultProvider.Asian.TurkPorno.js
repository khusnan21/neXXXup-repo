...
const baseUrl = "https://turkporno.com";
...
export async function getHome() {
    return [
        ...
        { title: "Türbanlı Porno", list: await getPage(baseUrl + "/turbanli-porno/") },
        { title: "Ensest Porno", list: await getPage(baseUrl + "/ensest-porno/") },
        { title: "Amatör Porno", list: await getPage(baseUrl + "/amat\u00f6r-porno/") },
        { title: "Popüler Porno", list: await getPage(baseUrl + "/populer-porno/") }
    ];
}
